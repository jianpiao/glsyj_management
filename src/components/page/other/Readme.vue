<template>
    <div>
        ...
        <div class="ms-doc">
            <h3>README.md</h3>
            <article>
                <h1>glsyj-management-system</h1>
                <p>广理商业街后台管理系统解决方案。</p>
                <h2>前言</h2>
                <p>广理商业街后台管理系统。基本表单、表格查看，数据修改排列，支持直接分类管理支持直接拖拽排序。</p>
