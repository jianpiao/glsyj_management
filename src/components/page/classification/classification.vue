    ...
    <section class="main">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>系统分类（拖动排序）</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
    ...
    export default {
        ...
        methods: {
            getData() {
                ...
                this.$axios({
                    method: 'post',
                    url: self.API + 'GoodsSystemCategoryList',
                    headers: {
            ...
            setSort() {
                ...
                this.$axios({
                    method: 'post',
                    url: self.API + 'SortGoodsSystemCategoryList',
                    data: {
            ...
            addCategory(i) {
                ...
                this.$axios({
                    method: 'post',
                    url: self.API + 'AddGoodsSystemCategory',
                    data: {
                        category_name: i
                    },
                    headers: {
            ...
            deleteCategory(v) {
                ...
                this.$axios({
                    method: 'post',
                    url: self.API + 'DeleteGoodsSystemCategory',
                    data: {
            ...
            handleDelete(i,v) {
                //  点击删除按钮
                let self = this
                this.$confirm('是否确认删除分类名  [ '+ v.category_name +" ]", '提示', {
